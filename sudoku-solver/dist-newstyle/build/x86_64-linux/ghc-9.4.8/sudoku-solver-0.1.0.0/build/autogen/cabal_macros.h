...
/* package twentefp-0.4.2 */
#ifndef VERSION_twentefp
#define VERSION_twentefp "0.4.2"
#endif /* VERSION_twentefp */
#ifndef MIN_VERSION_twentefp
#define MIN_VERSION_twentefp(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  4 || \
  (major1) == 0 && (major2) == 4 && (minor) <= 2)
#endif /* MIN_VERSION_twentefp */
...
#define CURRENT_PACKAGE_KEY "sudoku-solver-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "sudoku-solver-0.1.0.0-inplace"
